...
import { FaFacebookSquare, FaGitSquare, FaInstagramSquare, FaTwitterSquare } from 'react-icons/fa'
  ...
  return (
    <div className='max-w-[1520px] m-auto px-4 py-2 bg-[#24262b]'>
        <div className='py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
            <div>
                <h1 className='w-full text-3xl font-bold text-red-500 py-2'>HarshA Eats</h1>
