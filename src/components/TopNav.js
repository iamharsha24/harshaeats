    ...
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
        <div className='flex items-center'>
          ...
          <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>
            HarshA <span className='text-red-500 font-bold'>Eats</span>
          </h1>
          <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
            <p className='bg-red-500 text-white rounded-full p-2 text-bold'>Free</p>
        ...
        <button  className='bg-red-500 text-white hidden md:flex items-center mx-2 py-2 rounded-full'>
          ...
          />
          <h2 className='text-2xl p-4'>HarshA <span className='text-red-500 font-bold'>Eats</span></h2>
            <nav>
